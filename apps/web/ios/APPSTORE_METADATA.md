...
• Shot History — Track every shot you brew with detailed parameters including dose, yield, time, pressure, and flow data.

• Profile Library — Browse, save, and manage your collection of brewing profiles. Every AI-generated profile is saved for easy reuse.

• Real-Time Monitoring — Watch your shot in progress with live updates from your Meticulous machine.

• Intelligent Suggestions — Get profile recommendations based on your brewing history and preferences.

• Dark Mode — Beautiful dark interface designed for early morning brewing sessions.
...
espresso, coffee, meticulous, ai, barista, brewing, profiles, pour-over

## URLs

- **Privacy URL:** https://hessius.github.io/MeticAI/privacy
- **Support URL:** https://github.com/hessius/MeticAI/issues

## Review Notes

This app requires a Meticulous Espresso Machine on the local network to fully function. For review purposes, enter 'demo' as the Machine IP during onboarding to access the demo mode, which simulates all features.

## Screenshots

_To be added before submission. Required sizes:_
...
- **Data Tracking:** None
- **Third-Party SDKs:** Capacitor (app framework), Google Gemini (AI generation)
