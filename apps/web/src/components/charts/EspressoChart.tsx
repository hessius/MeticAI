...
export function EspressoChart({
  ...
  return (
    <div className={`${className} select-none [&_svg]:outline-none [&_.recharts-surface]:outline-none`} role="img" aria-label={liveMode ? t('a11y.chart.espressoShotLive') : t('a11y.chart.espressoShot')} style={{ WebkitTouchCallout: 'none', touchAction: 'pan-x pan-y' }}>
