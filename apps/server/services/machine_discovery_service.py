    ...
    try:
        ...
        try:
            ...
            if discovered:
                ...
                return DiscoveryResult(
                    found=True, ip=ip, hostname=hostname, method="mdns"
                )
        finally:
    ...
    try:
        ...
        try:
            ...
            if result:
                ...
                return DiscoveryResult(
                    found=True, ip=ip, hostname=hostname, method="hostname"
                )
...
async def _try_env_ip() -> DiscoveryResult:
    ...
    if await verify_machine(ip):
        ...
        return DiscoveryResult(found=True, ip=ip, hostname=None, method="env")
