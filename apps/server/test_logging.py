...
class TestRequestLogging:
    ...
    def test_request_includes_correlation_id(
        self, mock_vision_model, client, temp_log_dir
    ):
        ...
        response = client.post(
            "/analyze_coffee", files={"file": ("test.png", img_bytes, "image/png")}
        )
...
class TestLogRotation:
    ...
    def test_log_rotation_creates_backup(self, temp_log_dir):
        ...
        logger = setup_logging(
            log_dir=temp_log_dir, max_bytes=max_bytes, backup_count=2
        )
