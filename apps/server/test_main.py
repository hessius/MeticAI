...
from services.cache_service import _get_cached_image
...
class TestAnalyzeCoffeeEndpoint:
    ...
    def test_analyze_coffee_success(self, mock_vision_model, client, sample_image):
        ...
        mock_response = Mock()
        mock_response.text = (
            "Ethiopian Yirgacheffe, Light Roast, Floral and Citrus Notes"
        )
        ...
        response = client.post(
            "/analyze_coffee", files={"file": ("test.png", sample_image, "image/png")}
        )
    ...
    @patch.dict(os.environ, {"GEMINI_API_KEY": "test_api_key"})
    @patch("api.routes.coffee.get_vision_model")
    def test_analyze_coffee_with_whitespace(
        self, mock_vision_model, client, sample_image
    ):
    ...
    def test_analyze_coffee_api_error(self, mock_vision_model, client, sample_image):
        ...
        # Mock an API error
        mock_vision_model.return_value.generate_content.side_effect = Exception(
    ...
    def test_analyze_coffee_invalid_image(self, client):
        ...
        response = client.post(
            "/analyze_coffee", files={"file": ("test.txt", invalid_data, "text/plain")}
        )
...
class TestAnalyzeAndProfileEndpoint:
    ...
    @patch("api.routes.coffee.get_vision_model")
    def test_analyze_and_profile_with_image_only(
        self,
        mock_vision_model,
        mock_create_profile,
        mock_save_history,
        ...
        prompt_payload = (
            mock_vision_model.return_value.async_generate_content.call_args_list[-1][0][
                0
            ]
        )
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_analyze_and_profile_with_prefs_only(
        self, mock_vision_model, mock_create_profile, mock_save_history, client
    ):
        ...
        response = client.post(
            "/analyze_and_profile", data={"user_prefs": "Strong and intense espresso"}
        )
        ...
        prompt_payload = (
            mock_vision_model.return_value.async_generate_content.call_args[0][0]
        )
        prompt = prompt_payload[0]
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_analyze_and_profile_with_both(
        self,
        mock_vision_model,
        mock_create_profile,
        mock_save_history,
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_analyze_and_profile_profile_creation_error(
        self, mock_vision_model, mock_create_profile, client, sample_image
    ):
    ...
    def test_analyze_and_profile_exception(self, mock_vision_model, client):
        ...
        response = client.post("/analyze_and_profile", data={"user_prefs": "Default"})
    ...
    @patch.dict(os.environ, {"GEMINI_API_KEY": "test_api_key"})
    @patch("api.routes.coffee.get_vision_model")
    def test_analyze_and_profile_image_processing_error(
        self, mock_vision_model, client
    ):
    ...
    def test_analyze_and_profile_llm_silent_failure(self, mock_vision_model, client):
        ...
        response = client.post(
            "/analyze_and_profile", data={"user_prefs": "Berry, Florals, Medium Body"}
        )
    ...
    @patch.dict(os.environ, {"GEMINI_API_KEY": "test_api_key"})
    @patch("api.routes.coffee.get_vision_model")
    def test_analyze_and_profile_llm_silent_failure_empty_output(
        self, mock_vision_model, client
    ):
    ...
    @patch.dict(os.environ, {"GEMINI_API_KEY": "test_api_key"})
    @patch("api.routes.coffee.get_vision_model")
    def test_analyze_and_profile_llm_silent_failure_includes_history(
        self, mock_vision_model, client
    ):
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_analyze_and_profile_various_preferences(
        self,
        mock_vision_model,
        mock_create_profile,
        mock_save_history,
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_analyze_and_profile_sdk_create_called(
        self, mock_vision_model, mock_create_profile, client, sample_image
    ):
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_analyze_and_profile_special_characters(
        self, mock_vision_model, mock_create_profile, mock_save_history, client
    ):
    ...
    def test_analyze_and_profile_returns_409_when_locked(self, client):
        ...
        with patch.object(
            coffee_module._profile_generation_lock, "locked", return_value=True
        ):
            response = client.post(
                "/analyze_and_profile", data={"user_prefs": "Some espresso"}
            )
    ...
    def test_analyze_and_profile_409_with_api_prefix(self, client):
        ...
        with patch.object(
            ...
            response = client.post(
                "/api/analyze_and_profile", data={"user_prefs": "Some espresso"}
            )
...
class TestEdgeCases:
    ...
    def test_analyze_coffee_large_image(self, mock_vision_model, client):
        ...
        response = client.post(
            "/analyze_coffee", files={"file": ("large.png", img_bytes, "image/png")}
        )
    ...
    @patch.dict(os.environ, {"GEMINI_API_KEY": "test_api_key"})
    @patch("api.routes.coffee.get_vision_model")
    def test_analyze_coffee_very_long_response(
        self, mock_vision_model, client, sample_image
    ):
...
class TestEnhancedBaristaPersona:
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_prompt_includes_modern_barista_persona(
        self, mock_vision_model, mock_create_profile, client, sample_image
    ):
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_prompt_includes_complex_profile_support(
        self, mock_vision_model, mock_create_profile, client
    ):
        ...
        client.post("/analyze_and_profile", data={"user_prefs": "Test preferences"})
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_prompt_includes_naming_convention(
        self, mock_vision_model, mock_create_profile, client
    ):
        ...
        client.post("/analyze_and_profile", data={"user_prefs": "Strong espresso"})
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_prompt_includes_user_summary_instructions(
        self, mock_vision_model, mock_create_profile, client
    ):
        ...
        client.post("/analyze_and_profile", data={"user_prefs": "Test"})
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_prompt_includes_validation_rules(
        self, mock_vision_model, mock_create_profile, client
    ):
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_prompt_includes_error_recovery(
        self, mock_vision_model, mock_create_profile, client
    ):
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_distilled_mode_is_default(
        self, mock_vision_model, mock_create_profile, client
    ):
        ...
        prompt = mock_vision_model.return_value.async_generate_content.call_args[0][0][
            0
        ]
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_detailed_knowledge_mode(
        self, mock_vision_model, mock_create_profile, client
    ):
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_enhanced_prompt_with_both_inputs(
        self, mock_vision_model, mock_create_profile, client, sample_image
    ):
...
class TestValidationRetry:
    ...
    NO_JSON_REPLY = (
        "I had trouble creating the profile. Let me try a different approach next time."
    )
    ...
    @patch("api.routes.coffee.get_vision_model")
    def test_validation_passes_first_try(
        self,
        mock_vision_model,
        mock_validate,
        mock_create_profile,
        ...
        response = client.post(
            "/analyze_and_profile", data={"user_prefs": "Fruity and bright"}
        )
    ...
    @patch("api.routes.coffee.validate_profile")
    @patch("api.routes.coffee.get_vision_model")
    def test_validation_fails_then_succeeds_on_retry(
        self,
        mock_vision_model,
        mock_validate,
        mock_create_profile,
        ...
        invalid_result.errors = [
            "Stage 'Pre-infusion': pressure stage must have a flow limit"
        ]
        invalid_result.error_summary.return_value = (
            "1. Stage 'Pre-infusion': pressure stage must have a flow limit"
        )
        ...
        response = client.post(
            "/analyze_and_profile", data={"user_prefs": "Clean and balanced"}
        )
    ...
    @patch("api.routes.coffee.validate_profile")
    @patch("api.routes.coffee.get_vision_model")
    def test_validation_exhausts_retries(
        self,
        mock_vision_model,
        mock_validate,
        mock_create_profile,
        ...
        response = client.post(
            "/analyze_and_profile", data={"user_prefs": "Rich and bold"}
        )
    ...
    @patch("api.routes.coffee.validate_profile")
    @patch("api.routes.coffee.get_vision_model")
    def test_no_json_retries_then_fails(
        self, mock_vision_model, mock_validate, mock_save_history, client
    ):
        ...
        mock_vision_model.return_value.async_generate_content = AsyncMock(
            return_value=no_json
        )

        response = client.post(
            "/analyze_and_profile", data={"user_prefs": "Something impossible"}
        )
    ...
    @patch("api.routes.coffee.validate_profile")
    @patch("api.routes.coffee.get_vision_model")
    def test_no_json_then_json_on_retry(
        self,
        mock_vision_model,
        mock_validate,
        mock_create_profile,
        ...
        response = client.post(
            "/analyze_and_profile", data={"user_prefs": "Light and delicate"}
        )
    ...
    @patch("api.routes.coffee.validate_profile")
    @patch("api.routes.coffee.get_vision_model")
    def test_response_includes_generation_id(
        self,
        mock_vision_model,
        mock_validate,
        mock_create_profile,
        ...
        response = client.post(
            "/analyze_and_profile", data={"user_prefs": "Bright acidity"}
        )
...
class TestUnicodeEscapeInReSubFix:
    ...
    @patch("api.routes.coffee.validate_profile")
    @patch("api.routes.coffee.get_vision_model")
    def test_unicode_in_fixed_json_does_not_raise(
        self,
        mock_vision_model,
        mock_validate,
        mock_create_profile,
        ...
        response = client.post(
            "/analyze_and_profile", data={"user_prefs": "Test unicode handling"}
        )
...
class TestAdvancedCustomization:
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_advanced_customization_parameter_parsed(
        self, mock_vision_model, mock_create_profile, client
    ):
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_prompt_includes_advanced_customization_when_provided(
        self, mock_vision_model, mock_create_profile, client
    ):
        ...
        assert (
            "⚠️ MANDATORY EQUIPMENT & EXTRACTION PARAMETERS (MUST BE USED EXACTLY):"
            in prompt
        )
        ...
        assert (
            "CRITICAL: You MUST configure the profile to use these EXACT values."
            in prompt
        )
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_prompt_omits_advanced_customization_when_not_provided(
        self, mock_vision_model, mock_create_profile, client
    ):
        ...
        response = client.post(
            "/analyze_and_profile", data={"user_prefs": "Create a balanced profile"}
        )
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_advanced_customization_section_formatting(
        self, mock_vision_model, mock_create_profile, client
    ):
        ...
        response = client.post(
            "/analyze_and_profile",
            data={"user_prefs": "Test", "advanced_customization": advanced_params},
        )
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_advanced_customization_mandatory_instructions_included(
        self, mock_vision_model, mock_create_profile, client
    ):
        ...
        assert (
            "• If a temperature is specified, set the profile temperature to that EXACT value"
            in prompt
        )
        assert (
            "• If a dose is specified, the profile MUST be designed for that EXACT dose"
            in prompt
        )
        assert (
            "• If max pressure/flow is specified, NO stage should exceed those limits"
            in prompt
        )
        assert (
            "• If basket size/type is specified, account for it in your dose and extraction design"
            in prompt
        )
        assert (
            "• If bottom filter is specified, mention it in preparation notes" in prompt
        )

    @patch.dict(os.environ, {"GEMINI_API_KEY": "test_api_key"})
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_advanced_customization_with_image(
        self, mock_vision_model, mock_create_profile, client, sample_image
    ):
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_advanced_customization_with_user_prefs(
        self, mock_vision_model, mock_create_profile, client
    ):
        ...
        response = client.post(
            "/analyze_and_profile",
            data={"user_prefs": user_prefs, "advanced_customization": advanced_params},
        )
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_advanced_customization_with_image_and_user_prefs(
        self, mock_vision_model, mock_create_profile, client, sample_image
    ):
...
class TestCORS:
    ...
    @patch.dict(os.environ, {"GEMINI_API_KEY": "test_api_key"})
    @patch("api.routes.coffee.get_vision_model")
    def test_cors_headers_on_analyze_coffee(
        self, mock_vision_model, client, sample_image
    ):
    ...
    @patch("api.routes.coffee.async_create_profile", new_callable=AsyncMock)
    @patch("api.routes.coffee.get_vision_model")
    def test_cors_headers_on_analyze_and_profile(
        self, mock_vision_model, mock_create_profile, client
    ):
...
class TestStatusEndpoint:
    ...
    def test_status_endpoint_exists(self, mock_client_cls, mock_version, client):
        ...
        mock_response.json.return_value = [
            {"tag_name": "v2.0.0", "html_url": "", "prerelease": False}
        ]
    ...
    @patch("httpx.AsyncClient")
    def test_status_detects_updates_available(
        self, mock_client_cls, mock_version, client
    ):
    ...
    def test_status_endpoint_cors_enabled(self, mock_client_cls, mock_version, client):
        ...
        response = client.get(
            "/api/status", headers={"Origin": "http://localhost:3550"}
        )
...
class TestTriggerUpdateEndpoint:
    ...
    def test_trigger_update_cors_enabled(self, mock_client_cls, client):
        ...
        response = client.post(
            "/api/trigger-update", headers={"Origin": "http://localhost:3550"}
        )
...
class TestUpdateMethodEndpoint:
    ...
    @patch("api.routes.system._probe_watchtower_api", new_callable=AsyncMock)
    def test_update_method_reports_container_error(
        self, mock_probe, mock_subprocess_run, client
    ):
    ...
    @patch.dict(
        os.environ,
        {"GEMINI_API_KEY": "test_api_key", "WATCHTOWER_TOKEN": "test-token-123"},
    )
    @patch("httpx.AsyncClient")
    def test_update_method_sends_auth_header_when_token_set(
        ...
        assert (
            call_kwargs.kwargs.get("headers", {}).get("Authorization")
    ...
    @patch.dict(
        os.environ,
        {"GEMINI_API_KEY": "test_api_key", "WATCHTOWER_TOKEN": "trigger-token"},
    )
    @patch("httpx.AsyncClient")
...
class TestHistoryAPI:
    ...
    @patch.dict(os.environ, {"GEMINI_API_KEY": "test_api_key"})
    @patch("api.routes.history.load_history")
    def test_get_history_removes_image_preview(
        self, mock_load, client, sample_history_entry
    ):
    ...
    def test_delete_history_entry(
        self, mock_load, mock_save, client, sample_history_entry
    ):
    ...
    @patch.dict(os.environ, {"GEMINI_API_KEY": "test_api_key"})
    @patch("api.routes.history.load_history")
    def test_get_profile_json_not_available(
        self, mock_load, client, sample_history_entry
    ):
    ...
    @patch("api.routes.history.save_history")
    @patch("api.routes.history.load_history")
    def test_migrate_history_cleans_markdown_artifacts(
    ...
    def test_migrate_history_returns_correct_count(self, mock_load, mock_save, client):
        ...
        history_with_some_artifacts = [
            ...
            {
                "id": "3",
                "profile_name": "**Fixed 2**",
                "created_at": "2026-01-01T10:00:00+00:00",
            },
            {
                "id": "4",
                "profile_name": "Also Clean",
                "created_at": "2026-01-01T10:00:00+00:00",
            },
        ]
    ...
    @patch("api.routes.history.save_history")
    @patch("api.routes.history.load_history")
    def test_migrate_history_handles_missing_profile_name(
        self, mock_load, mock_save, client
    ):
    ...
    def test_migrate_history_no_changes_needed(self, mock_load, mock_save, client):
        ...
        clean_history = [
            {
                "id": "1",
                "profile_name": "Clean Profile 1",
                "created_at": "2026-01-01T10:00:00+00:00",
            },
            {
                "id": "2",
                "profile_name": "Clean Profile 2",
                "created_at": "2026-01-01T10:00:00+00:00",
            },
            {
                "id": "3",
                "profile_name": "Clean Profile 3",
                "created_at": "2026-01-01T10:00:00+00:00",
            },
        ]
...
"""
        entry = save_to_history(
            coffee_analysis="Test analysis", user_prefs="Light Body", reply=reply
        )
    ...
    def test_save_to_history_new_entry_first(self, mock_load, mock_save):
        ...
        save_to_history(
            coffee_analysis=None, user_prefs=None, reply="Profile Created: New Profile"
        )
...
class TestSecurityFeatures:
    ...
    @patch.dict(os.environ, {"GEMINI_API_KEY": "test_api_key"})
    @patch("services.meticulous_service.get_meticulous_api")
    def test_upload_profile_image_validates_content_type(
        self, mock_api, client, sample_image
    ):
    ...
    def test_apply_profile_image_validates_base64_size(self, mock_api, client):
        ...
        response = client.post(
            "/api/profile/test-profile/apply-image", json={"image_data": data_uri}
        )
...
class TestShotAnalysisHelpers:
    ...
    def test_extract_shot_stage_data(self):
        ...
        shot_data = {
            "data": [
                {
                    "time": 0,
                    "shot": {"weight": 0, "pressure": 2.0, "flow": 0.5},
                    "status": "during",
                    "stage_name": "Bloom",
                },
                {
                    "time": 5000,
                    "shot": {"weight": 2.0, "pressure": 2.0, "flow": 0.5},
                    "status": "during",
                    "stage_name": "Bloom",
                },
                {
                    "time": 10000,
                    "shot": {"weight": 10.0, "pressure": 9.0, "flow": 2.5},
                    "status": "during",
                    "stage_name": "Main",
                },
                {
                    "time": 25000,
                    "shot": {"weight": 36.0, "pressure": 9.0, "flow": 2.5},
                    "status": "during",
                    "stage_name": "Main",
                },
            ]
    ...
    def test_determine_exit_trigger_hit_with_less_than_comparison(self):
        ...
        exit_triggers = [{"type": "pressure", "value": 4.0, "comparison": "<="}]
    ...
    def test_determine_exit_trigger_hit_with_greater_than_comparison(self):
        ...
        exit_triggers = [{"type": "pressure", "value": 8.5, "comparison": ">="}]
    ...
    def test_determine_exit_trigger_hit_flow_less_than(self):
        ...
        exit_triggers = [{"type": "flow", "value": 2.0, "comparison": "<="}]
    ...
    def test_determine_exit_trigger_hit_zero_pressure(self):
        ...
        exit_triggers = [{"type": "pressure", "value": 1.0, "comparison": "<="}]
    ...
    def test_determine_exit_trigger_hit_zero_flow(self):
        ...
        exit_triggers = [{"type": "flow", "value": 0.5, "comparison": "<="}]
    ...
    def test_generate_execution_description_declining_pressure(self):
        ...
        assert (
            "declined" in desc.lower()
            or "decreased" in desc.lower()
            or "dropped" in desc.lower()
        )
        assert "9.0" in desc
        assert "6.0" in desc
    ...
    def test_generate_profile_target_curves_basic(self):
        ...
        shot_stage_times = {"Bloom": (0.0, 5.0), "Main": (5.0, 25.0)}
        ...
        shot_data = {
            "data": [
                ...
                {
                    "time": 5000,
                    "shot": {"weight": 2.0, "pressure": 2.0},
                    "status": "Bloom",
                },
                {
                    "time": 6000,
                    "shot": {"weight": 5.0, "pressure": 9.0},
                    "status": "Main",
                },
                {
                    "time": 25000,
    ...
    def test_generate_profile_target_curves_ramp(self):
        ...
        shot_stage_times = {"Ramp Up": (0.0, 5.0)}

        shot_data = {
            "data": [
                {
                    "time": 0,
                    "shot": {"weight": 0, "pressure": 2.0},
                    "status": "Ramp Up",
                },
                {
                    "time": 5000,
    ...
    def test_generate_profile_target_curves_flow_stage(self):
        ...
        shot_stage_times = {"Flow Stage": (0.0, 20.0)}
    ...
    def test_generate_profile_target_curves_nested_dynamics_format(self):
        ...
        shot_data = {
            "data": [
                {
                    "time": 0,
                    "shot": {"weight": 0, "flow": 1.3},
                    "status": "Ultra Slow Preinfusion",
                },
                {
                    "time": 19000,
                    "shot": {"weight": 5.0, "flow": 1.3},
                    "status": "Ultra Slow Preinfusion",
                },
                {
                    "time": 20000,
                    "shot": {"weight": 6.0, "pressure": 2.5},
                    "status": "Pressure Ramp Up",
                },
                {
                    "time": 45000,
                    "shot": {"weight": 36.0, "pressure": 4.0},
                    "status": "Pressure Ramp Up",
                },
            ]
        }
        ...
        profile_data = {
            "stages": [
                ...
                },
                {
                    ...
                    "name": "Stage2",
                    "type": "flow",
                    "dynamics": {"points": [[0, 2.0], [5, 3.0]], "over": "time"},
                },
            ],
            "variables": [],
        }

        shot_stage_times = {"Stage1": (0.0, 10.0), "Stage2": (10.0, 20.0)}
    ...
    def test_interpolate_weight_to_time_with_edge_cases(self):
        ...
        weight_time_pairs = [(0, 0.0), (10, 5.0), (20, 12.0), (40, 30.0)]
    ...
    def test_local_analysis_includes_profile_target_curves(self):
        ...
        shot_data = {
            "data": [
                ...
                {
                    "time": 6000,
                    "shot": {"weight": 5.0, "pressure": 9.0, "flow": 2.5},
                    "status": "Main",
                },
                {
                    "time": 25000,
...
class TestCheckUpdatesEndpoint:
    ...
    @patch("api.routes.system._get_running_version", return_value="2.0.0")
    @patch("httpx.AsyncClient")
    def test_check_updates_success_with_updates(
        self, mock_client_cls, mock_version, client
    ):
    ...
    @patch("api.routes.system._get_running_version", return_value="2.0.0")
    @patch("httpx.AsyncClient")
    def test_check_updates_github_unreachable(
        self, mock_client_cls, mock_version, client
    ):
...
class TestMachineProfilesEndpoint:
    ...
    def test_list_profiles_success(
        self, mock_load_history, mock_list_profiles, mock_get_profile, client
    ):
    ...
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    @patch("api.routes.profiles.load_history", return_value=[])
    def test_list_profiles_partial_failure(
        self, mock_load_history, mock_list_profiles, mock_get_profile, client
    ):
    ...
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    @patch("api.routes.profiles.load_history")
    def test_list_profiles_history_dict_format(
        self, mock_load_history, mock_list_profiles, mock_get_profile, client
    ):
        ...
        mock_load_history.return_value = {
            "entries": [{"profile_name": "Test Profile", "reply": "Description here"}]
        }
    ...
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    @patch("api.routes.profiles.load_history", return_value=[])
    def test_list_profiles_includes_derived_tags(
        self, mock_load_history, mock_list_profiles, mock_get_profile, client
    ):
        ...
        dynamics = type(
            "Dynamics",
            (),
            {"points": [[0, 2.0], [5, 4.0]], "over": "time", "interpolation": "linear"},
        )()
        stage1 = type(
            "Stage",
            (),
    ...
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    @patch("api.routes.profiles.load_history", return_value=[])
    def test_list_profiles_derived_tags_empty_without_stages(
        self, mock_load_history, mock_list_profiles, mock_get_profile, client
    ):
    ...
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    @patch("api.routes.profiles.load_history", return_value=[])
    def test_derived_tags_weight_range(
        self, mock_load_history, mock_list_profiles, mock_get_profile, client
    ):
        """Test that derived tags include weight range labels."""
        mock_profile = type(
            "Profile", (), {"id": "p1", "name": "Ristretto", "error": None}
        )()
        dynamics = type(
            "Dynamics",
            (),
            {"points": [[0, 9.0]], "over": "time", "interpolation": "linear"},
        )()
        stage = type(
            "Stage",
            (),
    ...
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    @patch("api.routes.profiles.load_history", return_value=[])
    def test_derived_tags_adaptive_detection(
        self, mock_load_history, mock_list_profiles, mock_get_profile, client
    ):
        """Test that profiles with $variable references get Adaptive tag."""
        mock_profile = type(
            "Profile", (), {"id": "p1", "name": "Adaptive", "error": None}
        )()
        dynamics = type(
            "Dynamics",
            (),
            {"points": [[0, "$pressure"]], "over": "time", "interpolation": "linear"},
        )()
        stage = type(
            "Stage",
            (),
    ...
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    @patch("api.routes.profiles.load_history", return_value=[])
    def test_derived_tags_structural_bloom(
        self, mock_load_history, mock_list_profiles, mock_get_profile, client
    ):
        """Test content-based bloom detection from zero-flow stage with time exit."""
        mock_profile = type(
            "Profile", (), {"id": "p1", "name": "TestProfile", "error": None}
        )()
        bloom_dyn = type(
            "Dynamics",
            (),
            {"points": [[0, 0.0], [5, 0.0]], "over": "time", "interpolation": "linear"},
        )()
        ...
        bloom_stage = type(
            ...
            (),
            {
                ...
                "dynamics": bloom_dyn,
                "limits": [],
                "exit_triggers": [time_exit],
            },
        )()
        main_dyn = type(
            "Dynamics",
            (),
            {"points": [[0, 3.0]], "over": "time", "interpolation": "linear"},
        )()
        main_stage = type(
            "Stage",
            (),
...
class TestMachineProfileJsonEndpoint:
    ...
    @patch("api.routes.profiles.async_get_profile", new_callable=AsyncMock)
    def test_get_profile_json_merges_synthesized_variables(
        self, mock_get_profile, client
    ):
    ...
    def test_get_profile_json_no_duplicate_variables(self, mock_get_profile, client):
        ...
        assert temp_vars[0]["value"] == 92.0, (
            "Should keep explicit value, not synthesized"
        )
        fw_vars = [v for v in variables if v["key"] == "final_weight"]
        assert len(fw_vars) == 1, "Should still add missing final_weight"

    @patch("api.routes.profiles.async_get_profile", new_callable=AsyncMock)
    def test_get_profile_json_synthesizes_when_no_variables(
        self, mock_get_profile, client
    ):
...
class TestProfileImportEndpoint:
    ...
    def test_import_profile_success(
        self, mock_generate_desc, mock_load_history, mock_save_history, client
    ):
        """Test successful profile import with description generation."""
        mock_generate_desc.return_value = (
            "Great espresso profile with balanced extraction"
        )
    ...
    @patch("api.routes.profiles.load_history", return_value=[])
    @patch("api.routes.profiles._generate_profile_description", new_callable=AsyncMock)
    def test_import_profile_without_description(
        self, mock_generate_desc, mock_load_history, mock_save_history, client
    ):
        ...
        profile_json = {"name": "Quick Import", "temperature": 92.0}
    ...
    def test_import_profile_already_exists(self, mock_load_history, client):
        ...
        profile_json = {"name": "Existing Profile", "temperature": 93.0}
        ...
        response = client.post("/api/profile/import", json={"profile": profile_json})
    ...
    def test_import_profile_missing_json(self, client):
        ...
        response = client.post(
            "/api/profile/import", json={"generate_description": True}
        )
    ...
    @patch("api.routes.profiles.load_history", return_value=[])
    @patch("api.routes.profiles._generate_profile_description", new_callable=AsyncMock)
    def test_import_profile_description_generation_fails(
        self, mock_generate_desc, mock_load_history, mock_save_history, client
    ):
        ...
        profile_json = {"name": "Fallback Profile", "temperature": 91.0}
    ...
    @patch("api.routes.profiles.save_history")
    @patch("api.routes.profiles.load_history")
    def test_import_profile_legacy_history_format(
        self, mock_load_history, mock_save_history, client
    ):
        """Test import with legacy history format (dict with entries)."""
        profile_json = {"name": "New Profile", "temperature": 94.0}

        # Legacy format
        mock_load_history.return_value = {"entries": [{"profile_name": "Old Profile"}]}

        response = client.post(
            "/api/profile/import",
            json={"profile": profile_json, "generate_description": False},
        )
...
class TestShotsByProfileEndpoint:
    ...
    def test_get_shots_by_profile_success(
        self,
        mock_set_cache,
        mock_get_cache,
        mock_fetch_shot,
    ...
    @patch("api.routes.shots.async_get_history_dates", new_callable=AsyncMock)
    @patch("api.routes.shots._get_cached_shots")
    def test_get_shots_by_profile_api_error(
        self, mock_get_cache, mock_get_dates, client
    ):
        """Test error handling when machine API fails."""
        mock_get_cache.return_value = (None, False, None)
    ...
    @patch("api.routes.shots._get_cached_shots")
    @patch("api.routes.shots._set_cached_shots")
    def test_get_shots_by_profile_no_matches(
        self,
        mock_set_cache,
        mock_get_cache,
        mock_fetch_shot,
    ...
    @patch("api.routes.shots._get_cached_shots")
    @patch("api.routes.shots._set_cached_shots")
    def test_get_shots_by_profile_with_limit(
        self,
        mock_set_cache,
        mock_get_cache,
        mock_fetch_shot,
    ...
    @patch("api.routes.shots.fetch_shot_data", new_callable=AsyncMock)
    @patch("api.routes.shots._get_cached_shots")
    def test_get_shots_by_profile_include_data(
        self, mock_get_cache, mock_fetch_shot, mock_get_dates, mock_get_files, client
    ):
        ...
        response = client.get(
            "/api/shots/by-profile/Full%20Data%20Profile?include_data=true"
        )
    ...
    @patch("api.routes.shots._get_cached_shots")
    @patch("api.routes.shots._set_cached_shots")
    def test_get_shots_by_profile_case_insensitive(
        self,
        mock_set_cache,
        mock_get_cache,
        mock_fetch_shot,
    ...
    @patch("api.routes.shots.async_get_history_dates", new_callable=AsyncMock)
    @patch("api.routes.shots._set_cached_shots")
    def test_get_shots_by_profile_force_refresh(
        self, mock_set_cache, mock_get_dates, mock_get_cache, client
    ):
        """Test force_refresh parameter bypasses cache."""
        # Cache exists but should be ignored
        cached_data = {"profile_name": "Cached", "shots": [], "count": 0}
        mock_get_cache.return_value = (cached_data, False, 1705320000.0)
    ...
    @patch("api.routes.shots._get_cached_shots")
    @patch("api.routes.shots._set_cached_shots")
    def test_get_shots_by_profile_partial_shot_errors(
        self,
        mock_set_cache,
        mock_get_cache,
        mock_fetch_shot,
...
class TestImageProxyEndpoint:
    ...
    @patch("api.routes.profiles._get_cached_image")
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    def test_image_proxy_profile_not_found_returns_placeholder(
        self, mock_list_profiles, mock_get_cache, client
    ):
    ...
    @patch("api.routes.profiles.async_get_profile", new_callable=AsyncMock)
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    def test_image_proxy_no_image_returns_placeholder(
        self, mock_list_profiles, mock_get_profile, mock_get_cache, client
    ):
    ...
    @patch("api.routes.profiles.async_get_profile", new_callable=AsyncMock)
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    def test_image_proxy_data_uri_invalid(
        self, mock_list_profiles, mock_get_profile, mock_get_cache, client
    ):
    ...
    def test_image_proxy_absolute_url_allowed_for_machine_host(
        ...
        mock_client.get.assert_awaited_once_with(
            "https://machine.local/profiles/profile-792/image", timeout=10.0
        )
    ...
    def test_image_proxy_fallback_to_settings_ip(
        ...
        mock_client.get.assert_awaited_once_with(
            "http://192.168.50.10/profiles/profile-793/image", timeout=10.0
        )
...
class TestGetProfileInfoEndpoint:
    ...
    def test_get_profile_info_success(
        self, mock_list_profiles, mock_get_profile, client
    ):
    ...
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    def test_get_profile_info_not_found_returns_status(
        self, mock_list_profiles, client
    ):
    ...
    @patch("api.routes.profiles.async_get_profile", new_callable=AsyncMock)
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    def test_get_profile_info_no_display(
        self, mock_list_profiles, mock_get_profile, client
    ):
...
class TestLocalShotAnalysisEndpoint:
    ...
    def test_local_shot_analysis_success(
        self, mock_list_profiles, mock_get_profile, mock_fetch_shot, client
    ):
    ...
    @patch("api.routes.shots.async_get_profile", new_callable=AsyncMock)
    @patch("api.routes.shots.async_list_profiles", new_callable=AsyncMock)
    def test_local_shot_analysis_with_preinfusion(
        self, mock_list_profiles, mock_get_profile, mock_fetch_shot, client
    ):
    ...
    @patch("api.routes.shots.fetch_shot_data", new_callable=AsyncMock)
    @patch("api.routes.shots.async_list_profiles", new_callable=AsyncMock)
    def test_local_shot_analysis_profile_not_found(
        self, mock_list_profiles, mock_fetch_shot, client
    ):
    ...
    @patch("api.routes.shots.async_get_profile", new_callable=AsyncMock)
    @patch("api.routes.shots.async_list_profiles", new_callable=AsyncMock)
    def test_local_shot_analysis_weight_deviation(
        self, mock_list_profiles, mock_get_profile, mock_fetch_shot, client
    ):
        ...
        shot_data = {
            ...
            "data": [
                ...
                {
                    "time": 25000,
                    "shot": {"weight": 45.0, "pressure": 9.0, "flow": 2.5},
                },  # Over target
            ],
        }
        mock_fetch_shot.return_value = shot_data
    ...
    @patch("api.routes.shots.fetch_shot_data", new_callable=AsyncMock)
    @patch("api.routes.shots.async_list_profiles", new_callable=AsyncMock)
    def test_local_shot_analysis_exception(
        self, mock_list_profiles, mock_fetch_shot, client
    ):
        """Test handling of unexpected exceptions."""
...
class TestGenerateProfileImageEndpoint:
    ...
    def test_generate_image_preview_mode(self, mock_process, mock_cache, client):
        ...
        with patch(
            "services.gemini_service.get_gemini_client", return_value=mock_client
        ):
            response = client.post(
                "/api/profile/Test%20Profile/generate-image?preview=true&style=abstract"
            )
    ...
    @patch("api.routes.profiles.async_get_profile", new_callable=AsyncMock)
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    def test_generate_image_save_to_profile(
        self,
        mock_list_profiles,
        mock_get_profile,
        mock_save_profile,
        ...
        with patch(
            ...
            response = client.post(
                "/api/profile/Test%20Profile/generate-image?preview=false"
            )
    ...
    def test_generate_image_no_api_key(self, client):
        ...
        with patch(
            "services.gemini_service.get_gemini_client",
            side_effect=ValueError("GEMINI_API_KEY environment variable is required"),
        ):
    ...
    def test_generate_image_invalid_style(self, mock_process, mock_cache, client):
        ...
        with patch(
            ...
            response = client.post(
                "/api/profile/Test/generate-image?style=invalid&preview=true"
            )
    ...
    @patch("api.routes.profiles.process_image_for_profile")
    @patch("api.routes.profiles._set_cached_image")
    def test_generate_image_profile_not_found_for_save(
        self, mock_cache, mock_process, mock_list_profiles, client
    ):
        ...
        with patch(
            ...
            response = client.post(
                "/api/profile/Nonexistent/generate-image?preview=false"
            )
    ...
    @patch("api.routes.profiles.process_image_for_profile")
    @patch("api.routes.profiles._set_cached_image")
    def test_generate_image_save_failure(
        self,
        mock_cache,
        mock_process,
        mock_list_profiles,
...
class TestLLMShotAnalysisEndpoint:
    ...
    @patch("api.routes.shots.fetch_shot_data", new_callable=AsyncMock)
    @patch("api.routes.shots.async_list_profiles", new_callable=AsyncMock)
    def test_llm_analysis_profile_not_found(
        self, mock_list_profiles, mock_fetch_shot, client
    ):
        """Test error when profile not found."""
    ...
    @patch("api.routes.shots.get_vision_model")
    @patch("api.routes.shots._perform_local_shot_analysis")
    def test_llm_analysis_model_error(
        self,
        mock_local_analysis,
        mock_get_model,
        mock_list_profiles,
    ...
    @patch("api.routes.shots.get_vision_model")
    @patch("api.routes.shots._perform_local_shot_analysis")
    def test_llm_analysis_with_description(
        self,
        mock_local_analysis,
        mock_get_model,
        mock_list_profiles,
    ...
    @patch("api.routes.shots.get_vision_model")
    @patch("api.routes.shots._perform_local_shot_analysis")
    def test_llm_analysis_with_variables(
        self,
        mock_local_analysis,
        mock_get_model,
        mock_list_profiles,
    ...
    @patch("api.routes.shots.get_vision_model")
    @patch("api.routes.shots._perform_local_shot_analysis")
    def test_llm_analysis_ai_unavailable(
        self,
        mock_local_analysis,
        mock_get_model,
        mock_list_profiles,
        ...
        mock_local_analysis.return_value = {"summary": {}, "stages": []}
        mock_get_model.side_effect = ValueError(
...
Adjust grind based on bean age."""
        ...
        response = client.post(
            "/api/profile/convert-description",
            json={
                "profile": {
                    "name": "Test Profile",
                    "temperature": 93.0,
    ...
    @patch("api.routes.profiles.load_history")
    @patch("api.routes.profiles.get_vision_model")
    def test_convert_description_with_history_update(
        self, mock_get_model, mock_load_history, mock_save_history, client
    ):
...
class TestErrorHandling:
    ...
    def test_compute_stage_stats_with_gravimetric_flow(self):
        ...
        entries = [
            {
                "time": 0,
                "shot": {"weight": 0, "pressure": 9.0, "gravimetric_flow": 2.0},
            },
            {
                "time": 5000,
                "shot": {"weight": 10.0, "pressure": 9.0, "gravimetric_flow": 2.5},
            },
        ]
    ...
    def test_analyze_stage_execution_with_variable_dynamics(self):
        ...
        variables = [
            {
                "key": "decline_pressure",
                "name": "Decline Pressure",
                "type": "pressure",
                "value": 6.0,
            },
        ]
        ...
        result = _analyze_stage_execution(
...
class TestImagePromptErrorHandling:
    ...
    def test_generate_image_with_invalid_prompt_result_none(self, mock_get_api, client):
        ...
        with patch(
            "prompt_builder.build_image_prompt_with_metadata", return_value=None
        ):
            response = client.post(
                "/api/profile/TestProfile/generate-image", params={"preview": "true"}
            )

            # Should return 500 error
            assert response.status_code == 500
            assert (
                "Failed to build image generation prompt" in response.json()["detail"]
            )

    @patch("services.meticulous_service.get_meticulous_api")
    def test_generate_image_with_invalid_prompt_result_not_dict(
        self, mock_get_api, client
    ):
        ...
        with patch(
            "prompt_builder.build_image_prompt_with_metadata", return_value="invalid"
        ):
            response = client.post(
                "/api/profile/TestProfile/generate-image", params={"preview": "true"}
            )
    ...
    def test_generate_image_with_valid_prompt_result(self, mock_get_api, client):
        ...
        with patch(
            "prompt_builder.build_image_prompt_with_metadata", return_value=valid_prompt
        ):
            response = client.post(
                "/api/profile/TestProfile/generate-image", params={"preview": "true"}
            )
        ...
        test_data = [
            {
                ...
                "reply": "**Profile Created:** TestProfile\n",
            }
        ]
...
class TestCacheManagementFunctions:
    ...
    def test_llm_cache_save_and_load(self):
        ...
        # Save an analysis
        save_llm_analysis_to_cache(
            "TestProfile", "2024-01-15", "shot.json", "Test analysis result"
        )
...
class TestVersionEndpointDetailed:
    ...
    def test_version_endpoint_cors_enabled(self, client):
        ...
        response = client.get(
            "/api/version", headers={"Origin": "http://localhost:3550"}
        )
...
class TestRunShotEndpoints:
    ...
    def test_machine_status_endpoint(
        self, mock_session_get, mock_get_settings, mock_get_last_profile, client
    ):
    ...
    @patch("api.routes.scheduling.async_get_settings", new_callable=AsyncMock)
    @patch("api.routes.scheduling.async_session_get", new_callable=AsyncMock)
    def test_machine_status_no_connection(
        self, mock_session_get, mock_get_settings, mock_get_last_profile, client
    ):
    ...
    @patch("api.routes.scheduling.async_get_settings", new_callable=AsyncMock)
    @patch("api.routes.scheduling.async_session_get", new_callable=AsyncMock)
    def test_machine_status_api_unavailable(
        self, mock_session_get, mock_get_settings, mock_get_last_profile, client
    ):
        """Test machine status when API is not available."""
        mock_session_get.side_effect = AttributeError(
            "'NoneType' object has no attribute 'base_url'"
        )
        mock_get_settings.side_effect = AttributeError(
            "'NoneType' object has no attribute 'get_settings'"
        )
        mock_get_last_profile.side_effect = AttributeError(
            "'NoneType' object has no attribute 'get_last_profile'"
        )
    ...
    @patch("api.routes.scheduling.async_execute_action", new_callable=AsyncMock)
    @patch("api.routes.scheduling.get_meticulous_api")
    def test_preheat_with_profile_preselection(
        self, mock_get_api, mock_execute_action, mock_load, client
    ):
    ...
    @patch("api.routes.scheduling.async_load_profile_by_id", new_callable=AsyncMock)
    @patch("api.routes.scheduling.get_meticulous_api")
    def test_run_profile_success(
        self, mock_get_api, mock_load_profile, mock_execute_action, client
    ):
    ...
    @patch("api.routes.scheduling.async_load_profile_by_id", new_callable=AsyncMock)
    @patch("api.routes.scheduling.get_meticulous_api")
    def test_run_profile_connection_error(
        self, mock_get_api, mock_load_profile, client
    ):
    ...
    def test_schedule_shot_with_preheat(self, client):
        ...
        assert response.status_code == 200
        data = response.json()
        assert data["scheduled_shot"]["preheat"]
...
class TestStartupAndLifespan:
    ...
    async def test_check_for_updates_task_success(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(
            main, "Path", lambda x: script_path if x == "/app/update.sh" else Path(x)
        )
        ...
        async def mock_run(*args, **kwargs):
            ...
            return subprocess.CompletedProcess(
                args=args[0], returncode=0, stdout="Check complete", stderr=""
            )
    ...
    async def test_check_for_updates_task_non_zero_exit(self, monkeypatch):
        ...
        async def mock_to_thread(func, *args, **kwargs):
            ...
            return subprocess.CompletedProcess(
                args=args, returncode=1, stdout="", stderr="Error occurred"
            )
...
class TestGetVisionModel:
    ...
    def test_get_gemini_client_lazy_initialization(self, monkeypatch):
        ...
        with patch(
            "services.gemini_service.genai.Client", side_effect=mock_client_constructor
        ):
    ...
    def test_get_vision_model_returns_wrapper(self, monkeypatch):
        ...
        mock_client_instance = MagicMock()
        with patch(
            "services.gemini_service.genai.Client", return_value=mock_client_instance
        ):
...
class TestSettingsEndpoints:
    ...
    def test_get_settings_with_stored_api_key_masks_and_marks_configured(
...
class TestSaveSettingsEndpoint:
    ...
    def test_save_gemini_model_persists_and_returns(
    ...
    def test_save_gemini_model_empty_falls_back_to_default(
        self, client, monkeypatch, tmp_path
    ):
...
class TestAdditionalCoveragePaths:
    ...
    def testsanitize_profile_name_for_filename(self):
        ...
        result = utils.sanitization.sanitize_profile_name_for_filename(
            "Test/Profile\\Name:123"
        )
...
class TestRecurringSchedulesPersistence:
    ...
    async def test_persistence_save_and_load(self, temp_persistence_file):
        ...
        persistence = services.scheduling_state.RecurringSchedulesPersistence(
    ...
    @pytest.mark.asyncio
    async def test_persistence_saves_all_schedules_including_disabled(
        self, temp_persistence_file
    ):
        ...
        test_schedules = {
            "enabled-schedule": {"name": "Enabled", "time": "07:00", "enabled": True},
            "disabled-schedule": {
                "name": "Disabled",
                "time": "08:00",
                "enabled": False,
...
class TestGetNextOccurrence:
    ...
    def test_daily_schedule(self):
        ...
        schedule = {"time": "07:00", "recurrence_type": "daily"}
    ...
    def test_weekdays_schedule_on_weekday(self):
        ...
        schedule = {"time": "08:30", "recurrence_type": "weekdays"}
    ...
    def test_weekends_schedule(self):
        ...
        schedule = {"time": "10:00", "recurrence_type": "weekends"}
    ...
    def test_interval_schedule_first_run(self):
        ...
        schedule = {"time": "06:00", "recurrence_type": "interval", "interval_days": 3}
...
class TestRecurringScheduleEndpoints:
    ...
    def test_create_recurring_schedule_missing_time(self, client):
        ...
        response = client.post(
            "/api/machine/recurring-schedules",
            json={"name": "No Time", "recurrence_type": "daily", "preheat": True},
        )
    ...
    def test_create_recurring_schedule_no_action(self, client):
        ...
        assert response.status_code == 400
        assert (
            "Either profile_id or preheat must be provided" in response.json()["detail"]
        )
    ...
    def test_update_recurring_schedule(self, client):
        ...
        response = client.put(
            ...
            json={"name": "Updated Name", "time": "08:00", "enabled": False},
        )
    ...
    def test_update_recurring_schedule_not_found(self, client):
        ...
        response = client.put(
            "/api/machine/recurring-schedules/nonexistent-id", json={"name": "New Name"}
        )
    ...
    def test_update_recurring_schedule_invalid_time(self, client):
        ...
        response = client.put(
            f"/api/machine/recurring-schedules/{schedule_id}", json={"time": "invalid"}
        )
...
class TestRecurringScheduleChecker:
    ...
    def test_schedule_enabled_filtering(self):
        ...
        enabled_schedules = {
            sid: s for sid, s in schedules.items() if s.get("enabled", True)
        }
...
class TestSchedulingStateDirect:
    ...
    async def test_schedule_persistence_save_and_load(self, tmp_path):
        ...
        test_data = {
            "schedule1": {"name": "Test", "time": "07:00", "status": "scheduled"}
        }
    ...
    async def test_save_scheduled_shots(self):
        ...
        with patch.object(
            scheduling_state, "_scheduled_shots_persistence"
        ) as mock_persistence:
    ...
    async def test_save_recurring_schedules(self):
        ...
        with patch.object(
            scheduling_state, "_recurring_schedules_persistence"
        ) as mock_persistence:
            mock_persistence.save = AsyncMock()
            scheduling_state._recurring_schedules = {"recurring1": {"name": "Test"}}

            await scheduling_state.save_recurring_schedules()
            mock_persistence.save.assert_called_once_with(
                {"recurring1": {"name": "Test"}}
            )
    ...
    async def test_load_recurring_schedules_function(self):
        ...
        with patch.object(
            ...
            mock_persistence.load = AsyncMock(
                return_value={"schedule1": {"enabled": True}}
            )

            await scheduling_state.load_recurring_schedules()
            assert scheduling_state._recurring_schedules == {
...
class TestMeticulousServiceDirect:
    ...
    async def test_execute_scheduled_shot_preheat_and_run(self):
        ...
        with patch(
            "services.meticulous_service.get_meticulous_api", return_value=mock_api
        ):
    ...
    async def test_fetch_shot_data_compressed(self):
        ...
        with patch(
            ...
            with patch(
                "services.meticulous_service._get_http_client", return_value=mock_client
            ):
...
class TestMainLifespanCoverage:
    ...
    async def test_lifespan_startup_and_shutdown(self):
        ...
        with patch(
            "main._restore_scheduled_shots", new_callable=AsyncMock
        ) as mock_restore:
            with patch(
                "main._load_recurring_schedules", new_callable=AsyncMock
            ) as mock_load:
...
class TestPrepareProfileForLLM:
    ...
    def test_prepare_profile_with_empty_dynamics(self):
        ...
        profile_data = {
            "name": "No Dynamics",
            "stages": [{"name": "Wait", "type": "time", "dynamics_points": []}],
        }
...
class TestProfileImageUpload:
    ...
    @patch("api.routes.profiles.process_image_for_profile")
    @patch("api.routes.profiles._set_cached_image")
    def test_upload_profile_image_not_found(
        self, mock_set_cache, mock_process, mock_list_profiles, client
    ):
    ...
    @patch("api.routes.profiles.process_image_for_profile")
    @patch("api.routes.profiles._set_cached_image")
    def test_upload_profile_image_api_error(
        self, mock_set_cache, mock_process, mock_list_profiles, client
    ):
...
class TestNormalizeProfileForMachine:
    ...
    def test_dynamics_interpolation_preserved(self):
        stage = {
            "name": "S1",
            "type": "flow",
            "dynamics": {"points": [], "over": "time", "interpolation": "curve"},
            "exit_triggers": [],
        }
        result = self._normalize({"name": "X", "stages": [stage]})
    ...
    def test_dynamics_dict_points_coerced_to_lists(self):
        ...
        stage = {
            "name": "S1",
            "type": "flow",
            "dynamics": {"points": [{"value": 2}], "over": "time"},
            "exit_triggers": [],
        }
        result = self._normalize({"name": "X", "stages": [stage]})
    ...
    def test_dynamics_list_points_preserved(self):
        stage = {
            "name": "S1",
            "type": "flow",
            "dynamics": {"points": [[0, 1.5], [5, 3]], "over": "time"},
            "exit_triggers": [],
        }
        result = self._normalize({"name": "X", "stages": [stage]})
    ...
    def test_adjustable_variable_no_emoji_added(self):
        ...
        v = [
            {"name": "Pressure", "key": "pressure_main", "type": "pressure", "value": 9}
        ]
        result = self._normalize({"name": "X", "variables": v, "stages": []})
...
class TestBridgeServiceFunctions:
    ...
    def test_check_s6_service_running(self, mock_run):
        ...
        mock_run.return_value = MagicMock(
            returncode=0, stdout="up (pid 123) 45 seconds"
        )
        from services.bridge_service import _check_s6_service
    ...
    def test_check_s6_service_down(self, mock_run):
        ...
        mock_run.return_value = MagicMock(
            returncode=0, stdout="down (signal SIGTERM) 2 seconds"
        )
        from services.bridge_service import _check_s6_service
...
class TestSettingsMQTTEnabled:
    ...
    def test_post_settings_mqtt_toggle(self, client):
        ...
        response = client.post("/api/settings", json={"mqttEnabled": False})
        assert response.status_code == 200
        data = response.json()
    ...
    def test_post_settings_mqtt_toggle_true(self, client):
        ...
        response = client.post("/api/settings", json={"mqttEnabled": True})
        assert response.status_code == 200
        data = response.json()
    ...
    def test_post_settings_ip_restarts_bridge(self, mock_path_cls, mock_run, client):
        ...
        response = client.post("/api/settings", json={"meticulousIp": "10.0.0.99"})
        assert response.status_code == 200
        data = response.json()
        assert "meticulous-bridge" in data.get("services_restarted", [])
...
class TestLastShotEndpoint:
    ...
    def test_last_shot_success(self, mock_dates, mock_files, mock_data, client):
        ...
        f1 = MagicMock()
        f1.name = "07:30:00.shot.json.zst"
        f2 = MagicMock()
        f2.name = "06:00:00.shot.json.zst"
        mock_files.return_value = [f1, f2]
        mock_data.return_value = {
            "profile_name": "Berry Blast Bloom",
            "time": "2026-02-14T07:30:00Z",
            "data": [{"time": 42300, "shot": {"weight": 36.5, "pressure": 9.0}}],
        }
    ...
    @patch("api.routes.shots.async_get_shot_files", new_callable=AsyncMock)
    @patch("api.routes.shots.async_get_history_dates", new_callable=AsyncMock)
    def test_last_shot_profile_from_nested_profile(
        self, mock_dates, mock_files, mock_data, client
    ):
...
class TestMachineCommandEndpoints:
    ...
    def test_command_load_profile(self, client):
        ...
        with (
            patch("api.routes.commands.get_mqtt_subscriber") as mock_sub,
            patch(
                "api.routes.commands._publish_command", return_value=True
            ) as mock_pub,
        ):
            mock_sub.return_value.get_snapshot.return_value = {
                "availability": "online",
            ...
            response = client.post(
                "/api/machine/command/load-profile", json={"name": "Berry Blast Bloom"}
            )
            assert response.status_code == 200
            assert response.json()["success"] is True
    ...
    def test_command_brightness(self, client):
        ...
        with patch("api.routes.commands.get_mqtt_subscriber") as mock_sub:
            ...
            response = client.post(
                "/api/machine/command/brightness", json={"value": 75}
            )
            assert response.status_code == 200
            assert response.json()["success"] is True
    ...
    def test_command_brightness_validation(self, client):
        ...
        response = client.post("/api/machine/command/brightness", json={"value": 150})
        assert response.status_code == 422
    ...
    def test_command_sounds(self, client):
        ...
        with patch("api.routes.commands.get_mqtt_subscriber") as mock_sub:
            ...
            response = client.post(
                "/api/machine/command/sounds", json={"enabled": False}
            )
            assert response.status_code == 200
            assert response.json()["success"] is True
...
class TestCommandConnectivityGaps:
    ...
    def test_command_brightness_rejected_when_offline(self, client):
        ...
        with patch("api.routes.commands.get_mqtt_subscriber") as mock_sub:
            ...
            response = client.post(
                "/api/machine/command/brightness", json={"value": 50}
            )
            assert response.status_code == 409
    ...
    def test_command_sounds_rejected_when_offline(self, client):
        ...
        with patch("api.routes.commands.get_mqtt_subscriber") as mock_sub:
            ...
            response = client.post(
                "/api/machine/command/sounds", json={"enabled": True}
            )
            assert response.status_code == 409

    def test_command_load_profile_empty_name_rejected(self, client):
        """Load profile rejects an empty profile name."""
        response = client.post("/api/machine/command/load-profile", json={"name": ""})
        assert response.status_code == 422
...
class TestTailscaleConfigureEndpoint:
    ...
    def test_save_auth_key(self, client):
        ...
        response = client.post(
            "/api/tailscale/configure", json={"authKey": "tskey-auth-test123"}
        )
        assert response.status_code == 200
        data = response.json()
        assert data["auth_key_configured"] is True
    ...
    def test_save_masked_key_ignored(self, client):
        ...
        response = client.post(
            "/api/tailscale/configure", json={"authKey": "tskey-***masked***"}
        )
        assert response.status_code == 200
    ...
    def test_auth_key_no_restart(self, client):
        ...
        response = client.post(
            "/api/tailscale/configure", json={"authKey": "tskey-auth-new"}
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_update_s6_env_writes_file(self, tmp_path):
        ...
        with patch("api.routes.system.os.path.isdir", return_value=True):
            with patch("builtins.open", mock_open()) as m:
                with patch(
                    "api.routes.system.os.path.join",
...
class TestBridgeResolveMachineIp:
    ...
    def _get_bridge_module():
        ...
        bridge_dir = os.path.abspath(
            os.path.join(os.path.dirname(__file__) or ".", "..", "bridge")
        )
    ...
    def test_resolve_default(self, tmp_path):
        ...
        mod = self._get_bridge_module()
        with patch.dict(
            os.environ, {"METICULOUS_IP": "", "DATA_DIR": str(tmp_path)}, clear=False
        ):
...
class TestAdaptPourOverProfile:
    ...
    def test_adapt_basic_with_bloom(self):
        ...
        weight_triggers = [
            t for t in infusion["exit_triggers"] if t["type"] == "weight"
        ]
    ...
    def test_adapt_does_not_mutate_template(self):
        ...
        adapt_pour_over_profile(target_weight=100.0, bloom_enabled=False)
        p2 = adapt_pour_over_profile(
            target_weight=500.0, bloom_enabled=True, bloom_seconds=60.0
        )
...
class TestTempProfileService:
    ...
    async def test_create_and_load_success(self):
        ...
        with (
            patch("services.temp_profile_service.async_create_profile") as mock_create,
            patch(
                "services.temp_profile_service.async_load_profile_by_id"
            ) as mock_load,
            ...
            result = await tps.create_and_load(
                mock_profile_json, params={"target_weight": 250}
            )
    ...
    async def test_create_and_load_replaces_existing(self):
        ...
        tps._set_active(
            ActiveTempProfile(profile_id="old-id", profile_name="Old Profile")
        )
    ...
    async def test_cleanup_stale_success(self):
        ...
        with (
            patch("services.temp_profile_service.async_list_profiles") as mock_list,
            patch("services.temp_profile_service.async_delete_profile") as mock_delete,
        ):
...
class TestRecipeAdapter:
    ...
    def test_list_recipes_each_has_slug(self):
        ...
        for recipe in list_recipes():
            assert "slug" in recipe, (
                f"Recipe missing slug: {recipe.get('metadata', {}).get('name')}"
            )
    ...
    def test_adapt_lance_hedrick_final_weight(self):
        ...
        profile = adapt_recipe_to_profile(recipe)
        assert profile["final_weight"] == pytest.approx(
            recipe["ingredients"]["water_g"]
        )

    def test_adapt_recipe_missing_recipes_dir_returns_empty_list(
...
class TestPrepareRecipeEndpoint:
    ...
    def test_prepare_recipe_success(self, mock_mqtt_sub, mock_temp_svc, client):
        ...
        async def _fake_load_ephemeral(
            profile_json, params, previous_profile_name=None
        ):
            return {
...
class TestEditProfileEndpoint:
    ...
    def test_edit_profile_success(self, mock_list, mock_get, mock_save, client):
        ...
        response = client.put(
            "/api/profile/TestProfile/edit", json={"temperature": 90.0}
        )
    ...
    def test_edit_profile_temperature_below_70_accepted(self, client):
        ...
        response = client.put(
            "/api/profile/TestProfile/edit", json={"temperature": 50.0}
        )
        assert response.status_code != 400
    ...
    def test_edit_profile_temperature_too_high(self, client):
        ...
        response = client.put(
            "/api/profile/TestProfile/edit", json={"temperature": 110.0}
        )
        assert response.status_code == 400
    ...
    def test_edit_profile_weight_zero(self, client):
        ...
        response = client.put("/api/profile/TestProfile/edit", json={"final_weight": 0})
        assert response.status_code == 400
    ...
    def test_edit_profile_empty_name(self, client):
        ...
        response = client.put("/api/profile/TestProfile/edit", json={"name": ""})
        assert response.status_code == 400
    ...
    def test_edit_profile_no_fields(self, client):
        ...
        response = client.put("/api/profile/TestProfile/edit", json={})
        assert response.status_code == 400
    ...
    def test_edit_profile_not_found(self, mock_list, client):
        ...
        response = client.put(
            "/api/profile/MissingProfile/edit", json={"temperature": 90.0}
        )
        assert response.status_code == 404
    ...
    def test_edit_profile_rename_cascades_to_history(
        ...
        response = client.put(
            "/api/profile/TestProfile/edit", json={"name": "RenamedProfile"}
        )
    ...
    def test_edit_profile_dual_route(self, mock_list, mock_get, mock_save, client):
        ...
        response = client.put("/profile/TestProfile/edit", json={"temperature": 88.0})
        assert response.status_code == 200
...
class TestProfileSync:
    ...
    @patch("api.routes.profiles.async_get_profile", new_callable=AsyncMock)
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    def test_sync_detects_updated_profiles(
        self, mock_list, mock_get, mock_history, client
    ):
    ...
    @patch("api.routes.profiles.async_get_profile", new_callable=AsyncMock)
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    def test_sync_detects_orphaned_entries(
        self, mock_list, mock_get, mock_history, client
    ):
    ...
    @patch("api.routes.profiles.async_get_profile", new_callable=AsyncMock)
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    def test_sync_in_sync_returns_empty(
        self, mock_list, mock_get, mock_history, client
    ):
    ...
    @patch("api.routes.profiles.async_get_profile", new_callable=AsyncMock)
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    def test_sync_backfills_missing_hash(
        self, mock_list, mock_get, mock_history, mock_update, client
    ):
    ...
    @patch("api.routes.profiles.async_get_profile", new_callable=AsyncMock)
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    def test_sync_status_detects_updated(
        self, mock_list, mock_get, mock_history, mock_update, client
    ):
    ...
    @patch("api.routes.profiles.async_get_profile", new_callable=AsyncMock)
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    def test_sync_status_backfills_missing_hash(
        self, mock_list, mock_get, mock_history, mock_update, client
    ):
    ...
    def test_save_to_history_stores_content_hash(self, mock_load, mock_save):
        ...
        entry = save_to_history(
            coffee_analysis="test beans", user_prefs="normal", reply=reply
        )
...
class TestMachineDetectEndpoint:
    ...
    @patch(
        "services.machine_discovery_service.discover_machine", new_callable=AsyncMock
    )
    ...
    def test_detect_not_found(self, mock_discover, client):
        ...
        mock_discover.return_value = DiscoveryResult(
            found=False,
            guidance="Could not automatically detect your Meticulous machine.",
        )
...
"""
    ...
    def test_classify_adjustable_variable(self):
        ...
        variables = [
            {"key": "flow_main", "name": "Main Flow", "type": "flow", "value": 2.5}
        ]
    ...
    def test_classify_info_variable(self):
        ...
        variables = [
            {"key": "info_dose", "name": "☕ Dose", "type": "weight", "value": 18}
        ]
...
class TestApplyRecommendationsEndpoint:
    ...
    def _make_mock_profile(
        ...
        profile.stages = []
        var = SimpleNamespace(key="flow_main", name="Main Flow", value=2.5, type="flow")
        info_var = SimpleNamespace(
            key="info_dose", name="☕ Dose", value=18.0, type="weight"
        )
...
class TestRunProfileWithOverrides:
    ...
    def test_apply_variable_overrides_skips_info_keys(self):
        ...
        result = apply_variable_overrides(
            profile, {"info_beans": 99, "pressure_main": 8.0}
        )
    ...
    def test_apply_variable_overrides_empty(self):
        ...
        profile = {
            "variables": [{"key": "x", "name": "X", "type": "pressure", "value": 1}]
        }
    ...
    def test_endpoint_run_with_overrides_none_mode(
        ...
        mock_load_ephemeral.return_value = {
            "profile_id": "p1",
            "profile_name": "Test Profile",
        }
...
class TestDialInGuide:
    ...
    def test_create_session(self):
        ...
        resp = client.post(
            "/api/dialin/sessions",
            json={"coffee": {"roast_level": "medium"}, "profile_name": "Test Profile"},
        )
    ...
    def test_list_sessions(self):
        self._clear()
        client = TestClient(app)
        client.post("/api/dialin/sessions", json={"coffee": {"roast_level": "light"}})
    ...
    def test_get_session(self):
        ...
        create_resp = client.post(
            "/api/dialin/sessions", json={"coffee": {"roast_level": "dark"}}
        )
    ...
    def test_add_iteration(self):
        ...
        client = TestClient(app)
        create_resp = client.post(
            "/api/dialin/sessions", json={"coffee": {"roast_level": "medium"}}
        )
        session_id = create_resp.json()["id"]
        resp = client.post(
            f"/api/dialin/sessions/{session_id}/iterations",
            json={"taste": {"x": 0.3, "y": -0.2, "descriptors": ["Sour", "Watery"]}},
        )
        assert resp.status_code == 201
    ...
    def test_add_multiple_iterations(self):
        ...
        client.post(
            f"/api/dialin/sessions/{session_id}/iterations",
            json={"taste": {"x": -0.5, "y": 0.1, "descriptors": ["Sour"]}},
        )
        resp = client.post(
            f"/api/dialin/sessions/{session_id}/iterations",
            json={"taste": {"x": -0.2, "y": 0.3, "descriptors": ["Sweet"]}},
        )
    ...
    def test_update_recommendations(self):
        ...
        client.post(
            f"/api/dialin/sessions/{session_id}/iterations",
            json={"taste": {"x": 0.5, "y": 0.0, "descriptors": []}},
        )
        resp = client.put(
    ...
    def test_dual_registration(self):
        ...
        client = TestClient(app)
        resp1 = client.post(
            "/dialin/sessions", json={"coffee": {"roast_level": "medium"}}
        )
        assert resp1.status_code == 201
        resp2 = client.post(
            "/api/dialin/sessions", json={"coffee": {"roast_level": "light"}}
        )
    ...
    def test_create_session_invalid_roast(self):
        ...
        client = TestClient(app)
        resp = client.post(
            "/api/dialin/sessions", json={"coffee": {"roast_level": "invalid"}}
        )
    ...
    def test_add_iteration_to_nonexistent_session(self):
        ...
        client = TestClient(app)
        resp = client.post(
            "/api/dialin/sessions/nonexistent/iterations",
            json={"taste": {"x": 0, "y": 0, "descriptors": []}},
        )
        assert resp.status_code == 404
...
class TestDialInPromptBuilder:
    ...
    def test_prompt_with_iterations(self):
        ...
        iterations = [
            {
                "iteration_number": 1,
                "taste": {"x": -0.5, "y": 0.2, "descriptors": ["Sour"]},
                "recommendations": [],
            },
            {
                "iteration_number": 2,
                "taste": {"x": -0.1, "y": 0.1, "descriptors": ["Sweet"]},
...
class TestImportFromUrl:
    ...
    def test_invalid_scheme(self, client):
        ...
        resp = client.post(
            "/api/import-from-url", json={"url": "ftp://example.com/profile.json"}
        )
        assert resp.status_code == 400
        assert (
            "http" in resp.json()["detail"].lower()
            or "scheme" in resp.json()["detail"].lower()
        )
    ...
    def test_ssrf_blocked(self, mock_validate, client):
        ...
        mock_validate.side_effect = ValueError(
            "URL resolves to private/reserved IP: 127.0.0.1"
        )
        resp = client.post(
            "/api/import-from-url", json={"url": "http://localhost:8080/profile.json"}
        )
        assert resp.status_code == 400
    ...
    def test_remote_non_200(self, mock_client_class, mock_ssrf, client):
        ...
        mock_client_class.side_effect = [
            TestImportFromUrl._mock_httpx_stream(
        ...
        resp = client.post(
            "/api/import-from-url", json={"url": "https://example.com/missing.json"}
        )
    ...
    def test_non_json_body(self, mock_client_class, mock_ssrf, client):
        ...
        mock_ssrf.return_value = None
        fake_cls = TestImportFromUrl._mock_httpx_stream(
            response_bytes=b"<html>Not JSON</html>"
        )
        mock_client_class.return_value = fake_cls()
        resp = client.post(
            "/api/import-from-url", json={"url": "https://example.com/page.html"}
        )
        assert resp.status_code == 400
    ...
    def test_missing_name_field(self, mock_client_class, mock_ssrf, client):
        ...
        mock_ssrf.return_value = None
        fake_cls = TestImportFromUrl._mock_httpx_stream(
            response_bytes=json.dumps({"temperature": 93.0}).encode()
        )
        mock_client_class.return_value = fake_cls()
        resp = client.post(
            "/api/import-from-url", json={"url": "https://example.com/profile.json"}
        )
        assert resp.status_code == 400
        assert "name" in resp.json()["detail"].lower()

    @patch(
        "api.routes.profiles.async_create_profile",
        new_callable=AsyncMock,
        return_value={"id": "m-1"},
    )
    @patch("api.routes.profiles.save_history")
    @patch(
        "api.routes.profiles.load_history",
        return_value=[{"id": "old-1", "profile_name": "URL Espresso", "reply": "desc"}],
    )
    @patch("api.routes.profiles._validate_url_for_ssrf")
    @patch("httpx.AsyncClient")
    def test_dedupe_exists(
        self, mock_client_class, mock_ssrf, mock_load, mock_save, mock_create, client
    ):
        """Returns 'exists' when a profile with the same name is already in history."""
        mock_ssrf.return_value = None
        fake_cls = TestImportFromUrl._mock_httpx_stream(
            response_bytes=json.dumps(self.VALID_PROFILE).encode()
        )
        mock_client_class.return_value = fake_cls()
        resp = client.post(
            "/api/import-from-url", json={"url": "https://example.com/profile.json"}
    ...
    def test_create_profile_includes_normalised_json(self, mock_http_factory):
        ...
        profile_json = {
            ...
            "stages": [
                {
                    "type": "flow",
                    "dynamics": {"points": [[0, 3]], "interpolation": "linear"},
                    "exit_triggers": [],
                }
            ],
        }

        result = asyncio.run(async_create_profile(profile_json))
...
class TestFetchMachineProfileDict:
    ...
    def test_returns_dict_from_machine(self, mock_http_factory):
        ...
        result = asyncio.run(fetch_machine_profile_dict("abc-123"))
    ...
    def test_raises_on_not_found(self, mock_http_factory):
        ...
        with pytest.raises(httpx.HTTPStatusError):
            asyncio.run(fetch_machine_profile_dict("nonexistent"))
...
class TestRepairEndpoint:
    ...
    @patch("api.routes.profiles.load_history")
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    def test_repair_fetches_from_machine(
        self, mock_list, mock_history, mock_fetch, mock_update, client
    ):
    ...
    @patch("api.routes.profiles.load_history")
    @patch("api.routes.profiles.async_list_profiles", new_callable=AsyncMock)
    def test_repair_normalizes_orphaned_entries(
        self, mock_list, mock_history, mock_normalize, mock_update, client
    ):
