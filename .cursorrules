...
**Recent Commits:**
- `6ff73d1 fix(pour-over): bloom weight target is reference only, not completion trigger`
- `2522e5d feat(pour-over): bloom indicator with weight target and dose multiplier`
- `39ad018 fix(pour-over): lower auto-start threshold and add weight escape hatch`
- `60ce7d4 fix(pour-over): contract chart x-axis to actual brew time after stop`
- `90bd886 chore(release): bump version to 2.1.0-beta.3`

**Working Tree:**
- M apps/mcp-server
- M apps/server/main.py
- M apps/web/public/locales/de/translation.json
- M apps/web/public/locales/en/translation.json
- M apps/web/public/locales/es/translation.json
- M apps/web/public/locales/fr/translation.json
- M apps/web/public/locales/it/translation.json
- M apps/web/public/locales/sv/translation.json
- M apps/web/src/components/PourOverView.test.tsx
- M apps/web/src/components/PourOverView.tsx
- ?? .continuity/
...
*Auto-generated by Continuity v2.3+ | Updated: 2026-03-08*
